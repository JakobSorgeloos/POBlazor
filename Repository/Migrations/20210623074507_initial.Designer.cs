...
namespace Repository.Migrations
{
    ...
    [Migration("20210623074507_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Comment", b =>
                {
                    ...
                    b.Property<string>("CommentTekst")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("GebruikerId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int?>("MediaKey")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MediaPlaylist", b =>
                {
                    b.Property<int>("MediaSitesKey")
                        .HasColumnType("int");

                    b.Property<int>("PlaylistsKey")
                        .HasColumnType("int");

                    b.HasKey("MediaSitesKey", "PlaylistsKey");

                    b.HasIndex("PlaylistsKey");
            ...
            modelBuilder.Entity("Domain.Comment", b =>
                {
                    b.HasOne("Domain.AppUser", "Gebruiker")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("MediaPlaylist", b =>
                {
                    b.HasOne("Domain.Media", null)
                        .WithMany()
                        .HasForeignKey("MediaSitesKey")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Playlist", null)
                        .WithMany()
                        .HasForeignKey("PlaylistsKey")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
